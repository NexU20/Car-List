...
public class CarList {
    ...
    public void searchList(String data, String column){
        flushSearchCatalog();
        if(column.equalsIgnoreCase("Kota")){
        ...
        if(column.equalsIgnoreCase("Pabrik")){
            for(Car c: carCatalogue){
        ...
        if(column.equalsIgnoreCase("Nomor Model")){
            for(Car c: carCatalogue){
        ...
        if(column.equalsIgnoreCase("Tahun Produksi")){
            for(Car c: carCatalogue){
        ...
        if(column.equalsIgnoreCase("Nomor Seri")){
            for(Car c: carCatalogue){
